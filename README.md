...
| 🤖 **Research Copilot** | a local research copilot for **any subject** — swappable domain profile · LangGraph + RAG · 100% local inference (Ollama + Mistral) · testable without any model | [Case study](https://jonathandavid.github.io/My-Portfolio/projects/gamedev-copilot) · [Repo](https://github.com/jonathanDavid/gamedev-copilot) |
